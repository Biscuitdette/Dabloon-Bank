...
function Library:create(options)
	...
	options = self:set_defaults({
		...
		Link = "https://github.com/Biscuitdette/Mercury"
	}, options)
	...
	local displayName; do
		...
		local displayName = profile:object("TextLabel", {
			RichText = true,
			Text = "Bienvenue, <font color='rgb(" ..  math.floor(c.R*255) .. "," .. math.floor(c.G*255) .. "," .. math.floor(c.B*255) .. ")'> <b>" .. LocalPlayer.DisplayName .. "</b> </font> !",
			TextScaled = true,
	...
	creditsTab:credit{Name = "Biscuitdette", Description = "Développeur", Discord = "Biscuitdette#0001", V3rmillion = "AbstractPoo"}
